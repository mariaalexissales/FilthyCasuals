...
local green = " <RGB:" ..
    ...
    "," .. getCore():getGoodHighlitedColor():getG() .. "," .. getCore():getGoodHighlitedColor():getB() .. "> "
local red = " <RGB:" ..
    getCore():getBadHighlitedColor():getR() ..
    "," .. getCore():getBadHighlitedColor():getG() .. "," .. getCore():getBadHighlitedColor():getB() .. "> "
...
local pref2_args = {
    ...
    Decimator     = function(item)
        ...
        local description = gold .. "Prefix Modifer: Decimator" ..
            green .. " <LINE> " .. string.format("%.0f", (sm1 * 100 - 100)) .. "% More Maximum Damage" ..
            green ..
            " <LINE> " .. string.format("%.0f", (sm2 * 100 - 100)) .. "% More Weapon Condition Lower Chance <LINE> "
    ...
    Zealot        = function(item)
        ...
        local description = gold .. "Prefix Modifer: Zealot" ..
            green .. " <LINE> " .. string.format("%.0f", (sm1 * 100 - 100)) .. "% More Critical Chance" ..
            green .. " <LINE> " .. string.format("%.0f", (sm2 * 100 - 100)) ..
            "% More Critical Damage Multiplier <LINE> "
...
local suff2_args = {
    ...
    AscendedPath = function(item)
        ...
        local description = gold .. "Suffix Modifer: Ascended Path" ..
            green .. " <LINE> Max Hit Count +" .. sm1 ..
            green ..
            " <LINE> " .. string.format("%.0f", (sm3 * 100 - 100)) .. "% More Weapon Condition Lower Chance <LINE> "
    ...
    DyingDawn = function(item)
        ...
        local description = gold .. "Suffix Modifer: Dying Dawn" ..
            green .. " <LINE> Max Hit Count +" .. sm1 ..
            green .. " <LINE> " .. string.format("%.0f", (sm3 * 100 - 100)) ..
            "% More Critical Damage Multiplier <LINE> "
    ...
    for _, item in ipairs(items) do                -- Check every item in inventory array
        if item:IsWeapon() and not item:isRanged() then
            ...
            local function itemStats()
                ...
                if weaponModData.mdzPrefix then
                    tooltip.description = tooltip.description ..
                        white .. " <LINE> Weapon Quality: " .. tierColor .. weaponModData.mdzPrefix .. " <LINE> "
                end
                if weaponModData.mdzMinDmg then
                    tooltip.description = tooltip.description ..
                        green ..
                        " <LINE> " .. string.format("%.2f", weaponModData.mdzMinDmg) .. "x More Minimum Damage <LINE> "
                end
                if weaponModData.mdzMaxDmg then
                    tooltip.description = tooltip.description ..
                        green .. string.format("%.2f", weaponModData.mdzMaxDmg) .. "x More Maximum Damage <LINE> "
                end
                if weaponModData.mdzCriticalChance then
                    tooltip.description = tooltip.description ..
                        green ..
                        string.format("%.2f", weaponModData.mdzCriticalChance) .. "x More Critical Chance <LINE> "
                end
                if weaponModData.mdzCritDmgMultiplier then
                    tooltip.description = tooltip.description ..
                        green ..
                        string.format("%.2f", weaponModData.mdzCritDmgMultiplier) ..
                        "x More Critical Damage Multiplier <LINE> "
                end

                tooltip.description = tooltip.description .. orange .. " <LINE> SoulForge Modifiers: <LINE> "
                tooltip.description = tooltip.description ..
                    green ..
                    " <LINE> Extra Base Maximum Damage: +" ..
                    math.floor(soulPower * 10) / 10 * numAugments / 4 .. " <LINE> "
                tooltip.description = tooltip.description ..
                    green .. "Extra Base Critical Chance: +" .. math.floor(soulPower * 50) / 10 * numAugments / 4 ..
                    "% <LINE> "
                tooltip.description = tooltip.description ..
                    green .. "Extra Base Critical Multi: +" .. math.floor(soulPower * 50) / 100 * numAugments / 4 ..
                    "x <LINE> "
                tooltip.description = tooltip.description ..
                    green .. "Extra Base Maximum Condition: +" .. baseMaxCond .. "% <LINE> "
                tooltip.description = tooltip.description ..
                    green .. "Extra Base Condition Lower Chance: +" .. baseMaxCond .. "% <LINE> "

                tooltip.description = tooltip.description ..
                    white .. " <LINE> Base Endurance Mod: " .. math.ceil(item:getEnduranceMod() * 100) / 100
                if weaponModData.EnduranceMod then
                    tooltip.description = tooltip.description ..
                        white .. " <LINE> SoulForged Endurance Modifier: " .. weaponModData.EnduranceMod
                end
                ...
                if isAugmented then
                    tooltip.description = tooltip.description ..
                        white .. " <LINE> No. of Augments: " .. weaponModData.Augments .. " <LINE> <LINE> "
                end
            ...
            if soulsFreed ~= nil then
                ...
                if soulsFreed < soulsRequired then
                    ...
                    function updatesoulsFreed(soulsFreed, soulsRequired, weaponRepairedStack)
                        local n_soulsFreed = math.max(
                            soulsFreed - math.floor(soulsRequired / ((math.min(7, weaponRepairedStack - 1) - 1) / 2)), 0)
                        return n_soulsFreed
                    end
                    ...
                    if weaponRepairedStack >= 5 then
                        option_repairstack = submenu:addOption(
                            "Remove 1x repair stack. (-" ..
                            soulDiff .. " souls.) New Soul Power: " .. n_soulsFreed .. "/" .. soulsRequired, item,
                            new_weaponRepairStack, player)
                    else
                        option_repairstack = submenu:addOption(
                            "Requires repair stacks of 4x or greater to remove a repair stack.", item, nil, player)
                    end
                    ...
                    if weaponRepairedStack < 5 then
                        ...
                        tooltip = ISWorldObjectContextMenu.addToolTip();
                        tooltip.description = tooltip.description ..
                            "This weapon is still serviceable. Higher repair stack requires less souls to mend."
                    ...
                    if soulForgeMaxCondition and permaMaxCondition and permaMaxCondition > 1 then
                        soulForgeMaxCondition =
                            soulForgeMaxCondition * permaMaxCondition
                    end
                    weaponCurrentCondition = item:getCondition()
                    weaponCondRepairAmount = math.ceil(weaponMaxCond / 3.5 * soulForgeMaxCondition)
                    weaponNewCondition = math.floor(math.min((weaponCurrentCondition + weaponCondRepairAmount),
                        weaponMaxCond * soulForgeMaxCondition) + 0.5)
                    ...
                    if weaponRepairedStack >= 5 then
                        option_weaponCondition = submenu:addOption(
                            "Repair weapon to: " ..
                            weaponNewCondition ..
                            "/" ..
                            math.floor(weaponMaxCond * soulForgeMaxCondition + 0.5) ..
                            " (-" .. soulDiff .. " souls.) New Soul Power: " .. n_soulsFreed .. "/" .. soulsRequired,
                            item,
                            new_weaponCondition, player)
                    else
                        option_weaponCondition = submenu:addOption(
                            "Requires repair stacks of 4x or greater to repair with souls.", item, nil, player)
                    end
                    ...
                    local function soulForgeWeapon(item, player)
                        ...
                        --print("Condition Lower Chance modifier: " .. weaponModData.ConditionLowerChance)
                        item:setConditionLowerChance(scriptItem:getConditionLowerChance() *
                            weaponModData.ConditionLowerChance)
                    ...
                    if item:isEquipped() then
                        option_soulForgeWeapon = submenu:addOption("Soul Forge Weapon", item,
                            soulForgeWeapon, player)
                    else
                        return
                    end
                    ...
                    if forged then
                        ...
                        if item:isEquipped() then
                            submenu1_soulForgedWeaponUpgrades = submenu:addOption(
                                "Upgrade Soul Forged Weapon", item, nil, player)
                        end
                        ...
                        local function addUpgradeOptions(_fix, option)
                            ...
                            local option_sm11_upgrade = submenu11:addOption(option, item,
                                function()
                                    if _fix == pref2_setstat or _fix == suff2_setstat then
                                        _fix[option](item, description,
                                            scriptItem, new_stat, neg1, neg2)
                                    else
                                        _fix[option](item, description,
                                            scriptItem, new_stat)
                                    end
                            ...
                            if count < 1 then
                                ...
                                tooltip.description = tooltip.description ..
                                    red .. " <LINE> " .. scriptItem:getDisplayName() .. " " .. "0/1";
                            elseif count >= 1 then
                                tooltip.description = tooltip.description ..
                                    green .. " <LINE> " .. scriptItem:getDisplayName() .. " " .. count .. "/1";
                            end
                            --end
                        end
                        ...
                        elseif weaponModData.Augments and weaponModData.Augments >= 4 and not weaponModData.SoulWrought then
                            ...
                            submenu1_soulWroughtWeaponUpgrades = submenu:addOption("Upgrade to Soul-Wrought Weapon", item,
                                function()
                                    ...
                                    weapon:setConditionLowerChance(scriptItem:getConditionLowerChance() *
                                        weaponModData.ConditionLowerChance)
                            ...
                            if wTier >= 1 then
                                itemToolTipMats("SoulForge.SoulCrystalT1",
                                    submenu1_soulWroughtWeaponUpgrades)
                            end
                            if wTier >= 2 then
                        ...
                        elseif weaponModData.Augments and weaponModData.Augments >= 4 and weaponModData.SoulWrought then
                            ...
                            submenu1_soulWroughtUpgrades = submenu:addOption("Upgrade Soul-Wrought Weapon", item, nil,
                                player)
                            ...
                            local function sw_itemToolTipMats(tooltip, material, option, quantity)
                                ...
                                if countItems(playerObj, material) < quantity then
                                    ...
                                    --tooltip = ISWorldObjectContextMenu.addToolTip();
                                    tooltip.description = tooltip.description ..
                                        red .. itemdisplayname .. " " .. count .. "/" .. quantity;
                                else
                                    --count = playerInv:getCountTypeRecurse(material)
                                    count = countItems(playerObj, material)
                                    tooltip.description = tooltip.description ..
                                        green .. itemdisplayname .. " " .. count .. "/" .. quantity;
                                end
                            end

                            local shard = { "SoulForge.SoulShardT1", "SoulForge.SoulShardT2", "SoulForge.SoulShardT3",
                                "SoulForge.SoulShardT4", "SoulForge.SoulShardT5" }
                            ...
                            local swUpgrade4 = submenu2:addOption("Add +1% to Critical Damage Multiplier Modifier", item,
                                function()
                            ...
                            local swUpgrade5 = submenu2:addOption("Add -0.1% to Endurance Usage Modifier", item,
                                function()
                                    if not weaponModData.EnduranceMod then
                                        weaponModData.EnduranceMod = o_scriptItem
                                            :getEnduranceMod()
                                    end
                    ...
                    elseif (weaponCurrentCondition < (weaponMaxCond) or soulsFreed < soulsRequired) then
                        ...
                        tooltip.description = tooltip.description ..
                            "Requires " ..
                            soulsRequired .. " Soul Power and full weapon condition to Soul Forge. <LINE> "
        ...
        if killDiff > 0 then
            ...
            if SoulThirstValue and SoulThirstValue > 0 then
                if ZombRand(0, 10000) <= SoulThirstValue * 100 then
                    SoulThirst = 1
                    HaloTextHelper.addTextWithArrow(character,
                        "+" ..
                        math.floor(killDiff * (math.floor(SoulThirst + 1.25)) - killDiff + 0.5) ..
                        " Additional Souls Gained", true, HaloTextHelper.getColorGreen());
                end
            end
            weaponModData.KillCount = weaponSouls + killDiff * (math.floor(SoulThirst + 1.25)) +
                killDiff *
                math.floor(tierzone / 2 + 0.25) --calculate and set new kill counter on weapon,
            weaponModData.PlayerKills =
                n_killcount                     --update player kill counter on weapon
